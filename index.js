  ...
  new SlashCommandBuilder()
      ...
      group.setName('member')
        ...
        .addSubcommand(sub =>
          sub.setName('warn')
            ...
            .addBooleanOption(o => o.setName('revert').setDescription('Try to undo their most recent logged action, where possible').setRequired(false))))
    .addSubcommandGroup(group =>
    ...
    .addSubcommandGroup(group =>
      group.setName('automod')
        .setDescription('View or toggle AutoMod rules')
        .addSubcommand(sub =>
          sub.setName('list')
            .setDescription('List all AutoMod rules and whether they are enabled'))
        .addSubcommand(sub =>
          sub.setName('toggle')
            .setDescription('Enable or disable an AutoMod rule')
            .addStringOption(o => o.setName('rule_name').setDescription('Exact rule name (see /request automod list)').setRequired(true))
      ...
      group.setName('setup')
        ...
        .addSubcommand(sub =>
          sub.setName('warnedrole')
            .setDescription('Set a role given after a member\'s first /request warning')
  ...
  try {
    if (commandName === 'ping') {
      ...
      if (group === 'member') {
        ...
        if (subcommand === 'list') await requestCommands.handleAutomodList(interaction);
        else if (subcommand === 'toggle') await requestCommands.handleAutomodToggle(interaction);
      }
    }
